...
#define GFX_MANAGER_SPR_SIZE (MON_PIC_SIZE * 4) // * 4 is unnecessary, MON_PIC_SIZE is sufficient - would need to increase the size of this if want more castform forms later
#define GFX_MANAGER_NUM_FRAMES 2  // Only 2 frames are needed, was 4
